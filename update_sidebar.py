...
print("Updated Sidebar.tsx with health dashboard link")
print("New section: Platform now includes '/health' -> System Health")
print("Icon used: Activity (monitor service status)")
