...
const navSections: NavSection[] = [
  {
    ...
    items: [
      { path: '/', label: 'Dashboard', icon: <Home size={20} />, description: 'Platform overview & statistics' },
      { path: '/health', label: 'System Health', icon: <Activity size={20} />, description: 'Monitor service status & uptime' },
      { path: '/audit-logs', label: 'Audit Logs', icon: <BarChart3 size={20} />, description: 'Activity tracking & audit trail' },
    ],
  },
  {
    title: 'Data Management',
    items: [
      { path: '/participants', label: 'Participants', icon: <Users size={20} />, description: 'Organizations & data partners' },
      { path: '/datasets', label: 'Datasets', icon: <Database size={20} />, description: 'Data assets & catalogs' },
      { path: '/schemas', label: 'Schemas', icon: <BookOpen size={20} />, description: 'Data schemas & definitions' },
  ...
  },
  {
    ...
    items: [
      { path: '/users', label: 'Users', icon: <Lock size={20} />, description: 'User management & access control' },
      { path: '/api/webhooks', label: 'Webhooks', icon: <Webhook size={20} />, description: 'Event subscriptions & webhooks' },
      { path: '/api/docs', label: 'API Docs', icon: <Code size={20} />, description: 'Interactive API documentation' },
    ],
  },
];
...
export const Sidebar = () => {
  ...
  const [expandedSections, setExpandedSections] = useState<string[]>(['Dashboard & Monitoring', 'Data Management']);
