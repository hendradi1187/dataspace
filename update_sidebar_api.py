...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/api/webhooks', label: 'Webhooks', icon: <Webhook size={20} />, description: 'Webhook configuration' },
    ],
  },
];
...
print("Updated Sidebar.tsx with Developer section")
print("New section: Developer (API Docs, Webhooks)")
