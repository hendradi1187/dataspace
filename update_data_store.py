...
data_store_content = '''import { create } from 'zustand';
import {
  Participant,
  Dataset,
  Policy,
...
filepath = 'D:/BMAD-METHOD/dataspace/apps/frontend/src/stores/data-store.ts'
with open(filepath, 'w') as f:
    f.write(data_store_content)

print("Updated data-store.ts with all missing types")
print("Added: Schema, Vocabulary, ComplianceRecord, Transaction, ClearingRecord, App")
